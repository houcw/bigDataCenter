        ...
        <template>
          <el-table :data="tableData" style="width: 100%" border>
            ...
            <el-table-column label="相似度">
              <template slot-scope="scope">{{scope.row.threshold?scope.row.threshold.toFixed(2):''}}</template>
            </el-table-column>
            <el-table-column prop="discernResult" label="识别结果" width="80">
              <template slot-scope="scope">
                <div :style="scope.row.discernResult==='Y'?{color:'rgba(68, 68, 68, 1)'}:{color:'rgba(255, 84, 84, 1)'}">
            ...
            <el-table-column prop="openResult" label="开锁结果" width="80">
              <template slot-scope="scope">
                <div :style="scope.row.openResult==='Y'?{color:'rgba(68, 68, 68, 1)'}:{color:'rgba(255, 84, 84, 1)'}">
